...
<div class="min-w-0 space-y-4 print:space-y-2">
    ...
    <div class="flex flex-wrap items-end gap-3 rounded border border-sand bg-white p-3 no-print">
        ...
        <button type="button" wire:click="resetFilters"
                class="rounded border border-sand px-3 py-1.5 text-sm text-charcoal/70 hover:text-charcoal">
            Reset
        </button>
    </div>

    <div class="flex flex-wrap gap-1 border-b border-sand no-print">
    ...
    @if ($window === null)
        <div class="rounded border border-sand bg-white p-6 text-sm text-charcoal/70">
    ...
    @else
            ...
            @else
                ...
                <div class="grid gap-4 lg:grid-cols-2">
                    @foreach ([['Actif', $bilan['actif'], $bilan['total_actif']], ['Passif', $bilan['passif'], $bilan['total_passif']]] as $side)
                        <div class="overflow-x-auto rounded border border-sand bg-white print-block">
        ...
        @if ($tab === 'flux' && $flux !== null)
            <div class="rounded border {{ $flux['mapped'] ? 'border-sand bg-white' : 'border-amber-300 bg-amber-50' }} p-3 text-sm {{ $flux['mapped'] ? 'text-charcoal/70' : 'text-amber-900' }} print-block">
