...
<div class="min-w-0 space-y-4">
    ...
    @if ($canManageAccounts && $showCreateForm)
        <section aria-label="{{ __('opes.ledger_screen.coa_create_form_title') }}" class="rounded-lg border border-sand bg-white p-4 shadow-sm sm:p-5">
    ...
    @if ($canManageAccounts && $editAccountId !== null)
        <section aria-label="{{ __('opes.ledger_screen.coa_edit_form_title') }}" class="rounded-lg border border-sand bg-white p-4 shadow-sm sm:p-5">
    ...
    @if ($canManageFiscalYears && $showFiscalYearForm)
        <section aria-label="{{ __('opes.ledger_screen.coa_fiscal_year_form_title') }}" class="rounded-lg border border-sand bg-white p-4 shadow-sm sm:p-5">
