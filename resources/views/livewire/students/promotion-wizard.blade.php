...
<div class="min-w-0 space-y-5">
    ...
    {{-- ===================== Step 1: Evaluate ===================== --}}
    <section class="rounded-lg border border-border-primary bg-white p-5 shadow-sm" aria-label="Evaluate">
        ...
        <div class="mt-5 flex items-center justify-end gap-3 border-t border-border-primary pt-4">
            @if ($run !== null && ! $applied)
                <button type="button" wire:click="reevaluate"
                        class="rounded border border-border-primary px-4 py-1.5 text-sm font-medium text-charcoal hover:bg-sand/40">
    ...
    @if ($run !== null)
        <section class="rounded-lg border border-border-primary bg-white p-5 shadow-sm" aria-label="Review and override">
            ...
            <div class="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-5">
                <div class="rounded-lg border border-border-primary bg-white p-3 text-center shadow-sm">
                    ...
                    <tbody>
                        @forelse ($decisions as $decision)
                            @php
                                ...
                                $badge = match (true) {
                                    $outcome === null => 'border-border-primary bg-sand/40 text-charcoal/60',
                            ...
                            @endphp
                            <tr class="border-b border-border-primary/60 align-top hover:bg-sand/20">
                                <td class="px-3 py-2">
                                ...
                                <td class="px-3 py-2 text-right">
                                    @if (! $applied)
                                        <button type="button" wire:click="openOverride({{ $decision->id }})"
                                                class="rounded border border-border-primary px-2.5 py-1 text-xs font-medium text-charcoal hover:bg-sand/40">
                                            Override
                                        </button>
                                    @endif
                                </td>
        ...
        {{-- ======================= Step 3: Apply ======================= --}}
        <section class="rounded-lg border border-border-primary bg-white p-5 shadow-sm" aria-label="Apply">
            ...
            @else
                ...
                <div class="mt-4 flex items-center justify-end gap-3 border-t border-border-primary pt-4">
                    @if (! $canApply)
