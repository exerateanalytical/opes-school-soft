    ...
    @else
        <div class="grid gap-4 sm:grid-cols-2">
            @foreach ($children as $child)
                <div wire:key="portal-child-{{ $child['id'] }}" class="rounded border border-border-primary bg-white p-4 shadow-sm">
                    ...
                    <div class="mt-3 flex flex-wrap gap-2 text-xs">
                        <a href="{{ route('portal.children.profile', $child['id']) }}"
                           class="rounded border border-border-primary px-2.5 py-1 font-medium text-charcoal hover:border-primary/50 hover:text-primary">
