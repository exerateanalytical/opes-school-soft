        ...
        <section class="rounded-lg border border-primary/40 bg-primary/5 p-4">
            <div class="grid gap-3 sm:grid-cols-2">
                <label class="text-sm">
                    ...
                    <select wire:model="guardianId" class="mt-1 w-full rounded border border-border-primary p-2">
                        <option value=""></option>
                ...
                <label class="text-sm">
                    ...
                    <select wire:model="type" class="mt-1 w-full rounded border border-border-primary p-2">
                        @foreach ($types as $t)
                ...
                <label class="text-sm">
                    ...
                    <input type="datetime-local" wire:model="scheduledAt" class="mt-1 w-full rounded border border-border-primary p-2">
                </label>
                <label class="text-sm">
                        ...
                        @if ($meeting->status === 'scheduled')
                            <div class="flex items-center gap-1">
                                <input type="text" wire:model="minutesDrafts.{{ $meeting->id }}"
                                       ...
                                       class="w-48 rounded border border-border-primary p-1 text-xs">
